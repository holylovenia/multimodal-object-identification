...
#     --model_name_or_path="./save/ambiguous_candidates/text-im-align/clip/openai_clip-vit-base-patch32_linear_lr0.0001_bs256" \
...
#     --utterance_turn both \
#     --num_utterances 3 \
#     --prediction_path ./cache/ambiguous_candidates/text-im-align/clip/_save_ambiguous_candidates_text-im-align_clip_openai_clip-vit-base-patch32_linear_lr00001_bs256_linear_lr5e-05_bs64/prediction_logits.pt


CUDA_VISIBLE_DEVICES=0 python3 text_image_alignment_prediction.py \
    --output_dir="./eval/coref_candidates|no_mm/conv-im-align/clip" \
    --cache_dir="./cache/coref_candidates|no_mm/conv-im-align/clip" \
    --model_name_or_path="./save/coref_candidates|no_mm/conv-im-align/clip/openai_clip-vit-base-patch32_linear_lr0.0001_bs256" \
    ...
    --utterance_turn both \
    --num_utterances 3 \
    --prediction_path "/home/holy/projects/ambiguous-mm-dialogue/cache/coref_candidates|no_mm/conv-im-align/clip/_save_coref_candidates|no_mm_conv-im-align_clip_openai_clip-vit-base-patch32_linear_lr00001_bs256_linear_lr5e-05_bs64/prediction_logits.pt"
