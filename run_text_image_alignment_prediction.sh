CUDA_VISIBLE_DEVICES=1 python3 text_image_alignment_prediction.py \
    ...
    --num_utterances 3 \
    --max_seq_length 77 \
    --prediction_path="./cache/text-im-align/_save_conv-im-align_clipper_openai_clip-vit-base-patch32_linear_lr00001_bs256_linear_lr5e-05_bs128/prediction_logits.pt"